      ...
      <div class="card">
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <button id="tambah" class="btn btn-success" onclick="checkStok()" enabled>Tambah</button>
              <button id="bayar" class="btn btn-success" data-toggle="modal" data-target="#modal" enabled>Bayar</button>
            </div>
          </div>
